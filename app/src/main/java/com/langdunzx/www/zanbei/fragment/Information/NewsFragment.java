...
import com.langdunzx.www.zanbei.activity.secondry.CityActivity;
import com.langdunzx.www.zanbei.activity.secondry.DetailsActivity;
import com.langdunzx.www.zanbei.adapter.NewsAdapter;
import com.langdunzx.www.zanbei.bean.NewsEntity;
...
public class NewsFragment extends Fragment implements
		HeadListView.OnJingDongRefreshListener {
	...
	private void initData() {
		newsList = ConstantsNews.getNewsList();
	}
		...
		public void handleMessage(Message msg) {
			...
			case SET_NEWSLIST:
				...
				if (mAdapter == null) {
					...
					// 判断是不是城市的频道
					if (channel_id == ConstantsNews.CHANNEL_CITY) {
						// 是城市频道
