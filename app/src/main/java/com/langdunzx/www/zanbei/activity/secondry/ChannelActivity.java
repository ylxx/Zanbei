...
import com.langdunzx.www.zanbei.adapter.DragAdapter;
 ...
 * 频道管理
 */
public class ChannelActivity extends BaseFragmentActivity implements OnItemClickListener {
	...
	private void initData() {
		...
		otherChannelList = ((ArrayList<ChannelItem>)ChannelManage.getManage(LangDunApplication.getApp().getSQLHelper()).getOtherChannel());
	...
	private void saveChannel() {
		ChannelManage.getManage(LangDunApplication.getApp().getSQLHelper()).deleteAllChannel();
		ChannelManage.getManage(LangDunApplication.getApp().getSQLHelper()).saveUserChannel(userAdapter.getChannnelLst());
		ChannelManage.getManage(LangDunApplication.getApp().getSQLHelper()).saveOtherChannel(otherAdapter.getChannnelLst());
	}
	...
	public void onBackPressed() {
		...
		if(userAdapter.isListChanged()){
			...
			setResult(InformationFragment.CHANNELRESULT, intent);
			finish();
			Log.d(TAG, "数据发生改变");
		}else{
			super.onBackPressed();
