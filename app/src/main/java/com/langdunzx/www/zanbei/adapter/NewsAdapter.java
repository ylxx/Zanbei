...
import com.langdunzx.www.zanbei.utils.DateTools;
import com.langdunzx.www.zanbei.utils.Options;
...
//			head_title.setText(news.getDate());
	...
	public int getAltMarkResID(int mark,boolean isfavor){
		...
		switch (mark) {
		case ConstantsNews.mark_recom:
			return R.drawable.ic_mark_recommend;
		case ConstantsNews.mark_hot:
			return R.drawable.ic_mark_hot;
		case ConstantsNews.mark_frist:
			return R.drawable.ic_mark_first;
		case ConstantsNews.mark_exclusive:
			return R.drawable.ic_mark_exclusive;
		case ConstantsNews.mark_favor:
			return R.drawable.ic_mark_favor;
		default:
			break;
		}
